...
let schemaAction = ['Kullanici', 'SistemMail', "GenelAyarlamalar", "AnasayfaSlider", "IletisimTalebi", "SacAnalizTalebi","BlogYazilari"];
let schema = [];
